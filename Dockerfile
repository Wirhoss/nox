...
# Liveness only. Readiness (/health/ready) decides whether traffic should
...
HEALTHCHECK --interval=30s --timeout=3s --start-period=10s --retries=3   CMD wget -q -O /dev/null http://127.0.0.1:8080/health/live || exit 1
