...
/** Write-only resource ownership exposed to plugins. */
export interface DisposableRegistry {
  add<T extends Disposable>(disposable: T): T;
}

export type DisposeAction = () => void | Promise<void>;

export function toDisposable(action: DisposeAction): Disposable {
