		...
		<div class="selected-list">
			{#each selectedBlueprints as blueprint, index}
				<div class="selected-participant">
					...
					<span class="avatar">{blueprint.id.slice(0, 1).toUpperCase()}</span>
