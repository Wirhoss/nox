import type { RiskSignal, RunStatus, RunTrigger } from './brokers.js';
...
/** Host slot occupied by the browser transport while its extension is active. */
interface ChatSurfaceHub {
  attach(transport: ChatTransport): () => void;
}
