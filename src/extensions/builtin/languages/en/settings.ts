const settingsMessages = Object.freeze({
  ...
  'settings.catalog.chooseProviderFirst': 'Choose a provider to list its models.',
  'settings.catalog.custom': 'Other — type an ID…',
  'settings.catalog.customHint':
    'Saved exactly as written. Nothing checks it against the provider until the first run.',
  'settings.catalog.customValue': 'Custom ID',
  'settings.catalog.embedding': 'embedding',
  'settings.catalog.modelsUnlistable': 'This provider could not list its models: {problem}',
  'settings.catalog.noModelList': 'it does not expose a model list',
  'settings.catalog.noModelsReported': 'This provider reports no models.',
  'settings.catalog.noProviders': 'No providers are configured yet.',
  'settings.catalog.notActivated':
    'Save this provider to see the models it serves. Only an activated instance can report them.',
  'settings.catalog.providerProblem': 'This provider is unavailable: {problem}',
  'settings.catalog.providerUnavailable': 'unavailable',
  'settings.catalog.refresh': 'Re-ask this provider',
  'settings.catalog.reported': 'reported',
  'settings.catalog.reportedCount.one': '{count} model available',
  'settings.catalog.reportedCount.other': '{count} models available',
  'settings.catalog.unknownProvider': 'Provider "{provider}" is not configured.',
  ...
  'settings.editor.curatedFormUnavailable':
    'This contributed type has no curated form. Continue in JSON mode.',
