const agentMessages = Object.freeze({
  ...
  'settings.agent.generationContextHelp':
    'Controles opcionales de muestreo conversacional y presión de contexto para este agente.',
  ...
  'settings.agent.stop': 'Secuencias de parada',
  'settings.agent.stopHint': 'Secuencias separadas por comas que terminan la generación.',
